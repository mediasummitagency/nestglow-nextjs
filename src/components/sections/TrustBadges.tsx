export function TrustBadges() {
  return (
    <section className="bg-white py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-row items-center justify-center gap-4">
        {/* Google Verified */}
        <div className="flex flex-1 items-center gap-3 bg-cream-50 border border-charcoal/10 rounded-2xl px-4 py-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-charcoal-40">Verified reviews</p>
          </div>
        </div>
