...
export default function OceanCountyPage() {
  return (
    <>
      <script
      ...
      <main className="pt-[72px]">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-5">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-charcoal leading-tight">
            House Cleaning in Ocean County, NJ
          </h1>
          <p className="text-charcoal-70 text-lg max-w-3xl leading-relaxed">
            {BUSINESS.name} provides residential and commercial cleaning throughout Ocean County — from Toms River and Brick to Point Pleasant and Jackson. Our team is fully insured, bonded, and experienced with the range of homes Ocean County offers, from shore rental turnovers to large family homes in Jackson and Berkeley Township.
          </p>
        ...
        <section className="bg-cream-100 border-y border-charcoal/5">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-4">
            <h2 className="text-xl font-bold text-charcoal">About our Ocean County service area</h2>
        ...
        <section className="bg-gold">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-center space-y-5">
            <h2 className="text-2xl md:text-3xl font-bold text-charcoal">
              Get a cleaning quote in Ocean County
            </h2>
