...
const countyFaqs = [
  {
    question: "How much does house cleaning cost in Monmouth County?",
    answer: "Most homes in Monmouth County run between $140 and $400 per clean depending on home size and service type. We provide a firm quote before any work begins — no surprises.",
  },
  {
...
export default async function MonmouthCountyPage({
  searchParams,
}: {
  ...
  const place = town ?? "Monmouth County";
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          eyebrow="Cleaning services in Monmouth County"
          heading={town ? `Cleaning services for ${town} homes.` : "Cleaning services for Monmouth County homes."}
        ...
        {/* Testimonials */}
        <Testimonials currentCounty="Monmouth" />
        ...
        {/* FAQ */}
        <FAQ
          headline="Questions about Monmouth County cleaning"
