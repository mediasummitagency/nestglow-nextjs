...
const countyFaqs = [
  {
    question: "How much does house cleaning cost in Middlesex County?",
    answer: "Most homes in Middlesex County run between $140 and $400 per clean depending on home size and service type. We provide a firm quote before any work begins — no surprises.",
  },
  {
...
export default async function MiddlesexCountyPage({
  searchParams,
}: {
  ...
  const place = town ?? "Middlesex County";
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          eyebrow="Cleaning services in Middlesex County"
          heading={town ? `Cleaning services for ${town} homes.` : "Cleaning services for Middlesex County homes."}
        ...
        {/* Testimonials */}
        <Testimonials currentCounty="Middlesex" />
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/cleaning-services/ocean-county" className="inline-flex items-center gap-2 px-4 py-2 bg-cream-100 rounded-full border border-charcoal/10 text-sm text-charcoal hover:border-brand hover:text-brand transition-colors">
        ...
        {/* FAQ */}
        <FAQ
          headline="Questions about Middlesex County cleaning"
